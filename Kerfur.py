...
def Color_Selection(): ## I'm so fucking tired, i dont think anyones going to try this... but humans are relentless fuckheads. getting every single one to follow the rules is impossible. delete this comment before publishing.
    while True:
        cls()
        print("KERFUR-OMEGA(C) 1990-1994 ASO")
        print("BIOS VERSION 1.0.0")
